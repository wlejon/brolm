...
//
// Used by the HuggingFace tokenizer.json loader (the T5 SentencePiece
// Unigram tokenizer) — so it aims to be correct and general, not
// config-specific.
//
// Recursive-descent. On malformed input, parse() throws std::runtime_error
